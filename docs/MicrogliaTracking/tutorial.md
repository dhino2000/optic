...
**Microglia** Tracking is a specialized tool developed for detecting microglial ROIs from XYT image stacks and analyzing their dynamics through time-series tracking. 
