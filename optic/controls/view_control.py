...
class ViewControl:
    ...
    def keyPressEvent(self, event: QKeyEvent) -> None:
        self.view_handler.handleKeyPress(event)

    def mousePressEvent(self, event: QMouseEvent) -> None:
        self.view_handler.handleMousePress(event)

    def mouseMoveEvent(self, event: QMouseEvent) -> None:
        self.view_handler.handleMouseMove(event)

    def mouseReleaseEvent(self, event: QMouseEvent) -> None:
        self.view_handler.handleMouseRelease(event)
...
#         self.config_manager  = config_manager
#         self.control_manager = control_manager
#         self.view_handler    = ViewHandler(q_view, self, app_key)
